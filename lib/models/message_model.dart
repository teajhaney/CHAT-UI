...
final User currentUser =
    User(id: 0, name: 'Current User', imageUrl: 'assets/images/sholly.jpg');

// USERS
final User greg = User(id: 1, name: 'Greg', imageUrl: 'assets/images/greg.jpg');
final User james =
    User(id: 2, name: 'James', imageUrl: 'assets/images/burger.jpg');
...
// FAVORITE CONTACTS
List<User> stories = [sam, steven, olivia, john, greg];
...
List<Message> chats = [
  ...
  Message(
    sender: olivia,
    time: '4:30 PM',
    text: 'Ahh, should have warned earlier',
    isLiked: false,
    unread: true,
  ),
  Message(
...
List<Message> messages = [
  ...
  Message(
    sender: james,
    time: '6:00 PM',
    text: 'Alright., Let\'s catch up later',
    isLiked: false,
    unread: true,
  ),
  Message(
    sender: currentUser,
    time: '5:35 PM',
    text: 'Nothing really, Just at home ',
    isLiked: false,
    unread: true,
  ),
  Message(
